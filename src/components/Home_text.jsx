  ...
  return (
    <div className="mx-auto mt-32 max-w-7xl sm:mt-10 sm:px-6 lg:px-8">
      <div className="relative overflow-hidden bg-gradient-to-r from-blue-300 to-blue-500 px-6 py-12 text-center shadow-2xl sm:rounded-3xl sm:px-16 text-white">
        ...
        <Link to="/destination" className="inline-block mt-8 px-6 py-3 font-semibold bg-blue-600 text-white rounded-full shadow-md transition duration-300 transform hover:scale-105 hover:bg-blue-800 hover:text-white hover-shadow-lg">Explore Now</Link>
      </div>
    </div>
  );
};
